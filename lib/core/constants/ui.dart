...
class TextStyles {
  ...
  static const styleWhite16Black = TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white);
  static const styleBold18Black = TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: MyColors.black1);
