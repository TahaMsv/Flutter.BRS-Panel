...
class AirportPositionSection {
  ...
  factory AirportPositionSection.fromJson(Map<String, dynamic> json) => AirportPositionSection(
        ...
        subs: List<AirportPositionSection>.from((json.entries.firstWhere((element) => element.key.startsWith("SUB"), orElse: () => MapEntry("SUB", [])).value).map((x) => AirportPositionSection.fromJson(x))),
