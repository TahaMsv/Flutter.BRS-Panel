...
class ExpansionTileController {
  ...
  /// Finds the [ExpansionTileController] for the closest [MyExpansionTile] instance
  ...
  static ExpansionTileController of(BuildContext context) {
    final _MyExpansionTileState? result = context.findAncestorStateOfType<_MyExpansionTileState>();
    if (result != null) {
  ...
  static ExpansionTileController? maybeOf(BuildContext context) {
    return context.findAncestorStateOfType<_MyExpansionTileState>()?._tileController;
  }
}
